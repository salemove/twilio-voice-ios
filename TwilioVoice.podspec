Pod::Spec.new do |s|
  ...
  s.license          = { :type => 'Commercial', :file => 'Copyright © 2011-2017 Twilio, Inc. All rights reserved. Use of this software is subject to the terms and conditions of the Twilio Terms of Service located at http://www.twilio.com/legal/tos' }
  s.author           = { 'Twilio' => 'help@twilio.com' }
  s.source           = { :git => 'https://github.com/salemove/twilio-voice-ios.git', :tag => '5.5.0' }

  s.documentation_url = 'https://twilio.github.io/twilio-voice-ios/docs/5.5.0'
